								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%" class="emailButton" style="background-color: white;">
									<tr>
										<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;color:#666666; text-align:left; font-size: 14px;">
											<p>
												Hi Admin,
												A trveler just mentioned that he/she just delivered product to the buyer. Please communicate with buyer to verify. Details are as follows-
												<br>
												<b>Traveler</b>
												<table width="100%">
													<tr>
												...
												<br>
												Thank you for being the Admin of airposted. See you again!
												<br>
												<b>Airposted Notification System.</b>
											</p>
										</td>
									</tr>
								</table>
