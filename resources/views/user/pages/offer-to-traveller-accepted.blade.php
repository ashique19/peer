...
<section class="row user-panel">
    <div class="col-sm-10 col-sm-offset-1 col-xs-12 xs-no-padding">
        ...
        <div class="col-xs-12 col-sm-6 xs-no-padding">
            <h1 class="section-heading black-text">Offers from Travelers (Accepted)</h1>
        </div>
            ...
            <li class="list-group-item push-up-5 push-down-5 offer-list">
                <div class="row pull-left-10">
                    ...
                    <div class="col-xs-12 col-sm-4 height-200 pull-20 offer-details">
                        ...
                        <p class="row">
                            <span class="col-xs-6">Total:</span> <span class="col-xs-6">USD {{$offer->total_price}}</span>
                            <a href="{{action('Payments@buyer')}}" class="btn white-bg green-text green-border square-border pull-right btn-xs">Pay Now</a>
                        </p>
                    </div>
                </div>
