        ...
        <div class="row">
            <div class="col-sm-3 col-md-2">
                <ul class="user-action-ul">
                    ...
                    <li class="user-actions active"><a href="{{action('Travels@myTravels')}}" >History</a></li>
                </ul>
            </div>
            ...
            <div class="col-sm-9 col-md-10">
                ...
                <div class="row">
                    ...
                    <h1 class="section-heading black-text">Trip History</h1>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        @else 
                                            ...
                                            {!! Form::hidden('id', $myTravel->id) !!}
                                            <button class="btn transparent-bg btn-xs" role="button" type="submit">Activate</button>
                                            {!! Form::close() !!}
                                            @endif 
                                        @endif
                                    </td>
