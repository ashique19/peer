                    ...
                    <div class="item row">
                        <div class="v-center">
                            <div class="col-xs-12 col-md-4">
                                ...
                                <div class="caption-button" data-animation="animated fadeInUp">
                                    <a href="#" class="button pp-bg btn-big">Start Shopping</a>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-4">
                                <div class="caption-photo one" data-animation="animated fadeInRight">
                                    <img src="{{asset('public/product/home/images/slider/banner2.png')}}" alt="" style="height:350px;width: 200px;">
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-4">
                                <div class="caption-title" data-animation="animated fadeInUp">
                                ...
                                <div class="caption-button" data-animation="animated fadeInUp">
                                    <a href="#" class="button pp-bg btn-big">Start Travelling</a>
                                </div>
                            </div>
                    ...
                    <div class="item row">
                        <div class="v-center">
                            <div class="col-xs-12 col-md-8">
                                <div class="caption-title" data-animation="animated fadeInUp">
                                    <p class="title-sm bold text_color_1">Shop around the world,</p>
                                </div>
                                <div class="caption-title caption-desc" data-animation="animated fadeInUp">
                                    <p class="title-sm ">from your comfort</p>
                            ...
                            <div class="col-xs-6 col-md-4">
                                <div class="caption-photo two" data-animation="animated fadeInRight">
                                    <img src="{{asset('public/product/home/images/slider/banner3.png')}}" alt=""  style="height:350px;width: 200px;">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xs-12">
                <div class="clients">
                    ...
                    <div class="item">
                        <div class="item-top">
                            <span>-34%</span>
                            <img style="background: <?php echo "#".str_pad(dechex(rand(0x000000, 0xFFFFFF)), 6, 0, STR_PAD_LEFT); ?>;" src="{{asset('public/product/home/images/pp/mobile.jpg')}}" alt="">
                        </div>
                    ...
                    <div class="item">
                        <div class="item-top">
                            <span>Prime</span>
                            <img src="{{asset('public/product/home/images/pp/mobile.jpg')}}" alt="">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <h5 class="title"><span  class="title-why-us text_color_1">Do<br>you Love to<br>Travel?</span><br><span class="text_color_dark">
                                <i class="fas fa-long-arrow-alt-down"></i>
<a href="#search-product"><b>I want to buy?</b></a></span></h5>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="row bullet-content">
                            <div class="col-md-1">
                                <img src="{{asset('public/product/home/images/pp/bullet.svg')}}">
                            </div>
                            <div class="col-md-11">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6">
                        <h5 class="title"><span  class="title-why-us text_color_1">Do<br>you Love to<br>Buy?</span><br>
                            <span class="text_color_dark"><a href="#how-it-works"><b>I want to travel...?</b></a></span>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-offset-2 col-md-5">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <img src="{{asset('public/product/home/images/pp/demo.jpg')}}" class="img-responsive rounded-circle" >
                            </div>
                            <div class="col-md-8">
