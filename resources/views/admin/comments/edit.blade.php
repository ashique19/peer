...
{!! Form::open( ['method'=>'patch', 'url'=> action('Comments@update', $comment->id), 'enctype'=>'multipart/form-data' ]) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::select('is_published', [ ''=>'-Select-','1'=>'Yes', '0'=>'No'], $comment->is_published , ['class'=>'form-control']) !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::text('commenter_name', $comment->commenter_name , ['class'=>'form-control']) !!}
            </div>
                
            <div class="form-group">
                {!! Form::label('commenter_email', 'Commenter email: ') !!}
                {!! Form::text('commenter_email', $comment->commenter_email , ['class'=>'form-control']) !!}
            </div>
