...
{!! Form::open( ['method'=>'patch', 'url'=> action('Messages@update', $message->id), 'enctype'=>'multipart/form-data' ]) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::select('message_from', \App\User::lists('name', 'id'), $message->message_from , ['class'=>'form-control']) !!}
            </div>
                
            <div class="form-group">
                {!! Form::label('message_to', 'Message to: ') !!}
                {!! Form::select('message_to', \App\User::lists('name', 'id'), $message->message_to , ['class'=>'form-control']) !!}
            </div>
            ...
            <div class="form-group">
                {!! Form::label('message_id', 'Message: ') !!}
                {!! Form::select('message_id', \App\Message::lists('name', 'id'), $message->message_id , ['class'=>'form-control select2']) !!}
            </div>
