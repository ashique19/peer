...
{!! Form::open( ['method'=>'patch', 'url'=> action('Settings@update', $setting->id), 'enctype'=>'multipart/form-data' ]) !!}
            ...
            <div class="form-group">
                {!! Form::label('google_map_api', 'Google Map API KEY: ') !!}
                {!! Form::text('google_map_api', $setting->google_map_api , ['class'=>'form-control']) !!}
            </div>
                
            <div class="form-group">
                {!! Form::label('google_map_location', 'Google Map Location: ') !!}
                {!! Form::text('google_map_location', $setting->google_map_location , ['class'=>'form-control']) !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::text('transaction_charge', $setting->transaction_charge , ['class'=>'form-control']) !!}
            </div>
