...
<section class="col-md-10 col-md-offset-1 push-down-20">
    ...
    {!! Form::open( ['url'=> action('Notifications@store'), 'class'=> 'form form-inline', 'enctype'=>'multipart/form-data' ]) !!}
        ...
        {!! Form::hidden('notification_to', $user->id ) !!}
        ...
        <div class="col-sm-6 col-xs-12 well push-up-10">
            ...
            <div class="row push-up-20">
                <div class="input-group col-xs-12">
                    ...
                    <input type="text" class="form-control" id="link" placeholder="URL (optional)" aria-describedby="link" style="margin: 0px;">
                </div>
            </div>
            
            <div class="row">
                {!! Form::submit('Send to- '. $user->name, ['class'=>'form-control btn btn-success btn-block push-up-20', 'style'=> 'margin-left: 0px; margin-right: 0px;']) !!}
            </div>
...
<section class="col-md-10 col-md-offset-1 push-down-20">
    ...
    <h4 class="page-title btn-info">Filters: 
        ...
        {!! Form::select('search_name', [], null, ['class'=> 'form-control user-search', 'placeholder'=> '-Filter by User-']) !!}
        {!! Form::submit('Filter', ['class'=> 'btn btn-primary btn-sm']) !!}
        {!! Form::close() !!}
        </span>
    </h4>
    
    <h4 class="page-title">Notification from/to: {{ $user->name }}</h4>
