...
class Newsletters extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.newsletters.index', ['newsletters'=> Newsletter::latest()->paginate(20)]);
    ...
    public function searchIndex(Request $request)
    {
        ...
        return view('admin.newsletters.index', ['newsletters'=> $result->latest()->paginate(20)]);
    ...
    public function store(newslettersStoreRequest $request)
    {
        ...
        $save_success = Newsletter::create($request->all());
        
        if($save_success){
        
            return redirect()->action('Newsletters@index')->withErrors('Data has been stored successfully.');
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(newslettersStoreRequest $request, $id)
    {
        $newsletter = Newsletter::find($id);
        
        
        $save_success = Newsletter::find($id)->update($request->all());
        
        if($save_success)
        {
            return redirect()->action('Newsletters@index')->withErrors('Data has been updated successfully.');
    ...
    public function destroy($id, Request $request)
    {
        ...
        if($newsletter)
        {
            ...
            if($newsletter->delete())
            {
                ...
                return redirect()->action('Newsletters@index')->withErrors('Data has been deleted successfully.');
