...
class Comments extends Controller
{
    ...
    public function searchIndex(Request $request)
    {
        ...
        $result =   new Comment;
					...
					($request->input('is_published'))   ? $result = $result->where('is_published', 'like', '%'.$request->input('is_published').'%') : false;
					...
					($request->input('commenter_name'))   ? $result = $result->where('commenter_name', 'like', '%'.$request->input('commenter_name').'%') : false;
					($request->input('commenter_email'))   ? $result = $result->where('commenter_email', 'like', '%'.$request->input('commenter_email').'%') : false;
