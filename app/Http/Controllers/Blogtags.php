...
use App\Http\Requests\blogtagsStoreRequest;
...
class Blogtags extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.blogtags.index', ['blogtags'=> Blogtag::latest()->paginate(20)]);
    ...
    public function searchIndex(Request $request)
    {
        ...
        return view('admin.blogtags.index', ['blogtags'=> $result->latest()->paginate(20)]);
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(blogtagsStoreRequest $request)
    {
        ...
        $save_success = Blogtag::create($request->all());
        
        if($save_success){
        
            return redirect()->action('Blogtags@index')->withErrors('Data has been stored successfully.');
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(blogtagsStoreRequest $request, $id)
    {
        $blogtag = Blogtag::find($id);
        ...
        if($request->has('banner_photo_delete'))
        {
            ...
            if($blogtag->banner_photo)
            {
                
                $image_to_delete_lg = $blogtag->banner_photo;
        ...
        $save_success = Blogtag::find($id)->update($request->all());
        
        if($save_success)
        {
            return redirect()->action('Blogtags@index')->withErrors('Data has been updated successfully.');
    ...
    public function destroy($id, Request $request)
    {
        ...
        if($blogtag)
        {
            ...
            if($blogtag->delete())
            {
                ...
                return redirect()->action('Blogtags@index')->withErrors('Data has been deleted successfully.');
    ...
    public function blogs($id)
    {
        ...
        $tag   = \App\Blogtag::find($id);
        
        $blogs      = ($tag) ? $tag->blogs()->paginate(20) : [];
        
        return view('admin.blogtags.blogs', compact('tag','blogs'));
