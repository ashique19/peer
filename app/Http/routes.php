...
Route::get('push', 'StaticPageController@dbPush');
...
Route::get('/', ['as'=>'home', 'uses'=>'StaticPageController@newHome']);
...
// Home page
Route::get('home',       'StaticPageController@newHome');
...
Route::group(['prefix'=>'auth'], function(){
    ...
    Route::get('social/{social}',               'AccessController@social')->name('social-login');
...
Route::group(['middleware' => ['auth','permission'], 'prefix' => 'admin'], function() use ($router)
{
    ...
    */
    ...
    Route::get('links/{id}/edit', 'LinksController@edit');
    Route::patch('links/{id}/update', 'LinksController@update');
    Route::delete('links/{id}/update', 'LinksController@destroy');
    ...
    */
    ...
    // Peerposted Route
    Route::get('product/requests', 'Buyers@newIndex')->name('buyers-list');
    Route::get('product/{id}/update/status', 'Buyers@updateStatus')->name('update-product-status');
    ...
    */
    ...
    Route::resource('payout-requests', 'Payouts');
    Route::get('my-orders', 'MyOrders@index');
...
Route::get('dashboard', 'UserAccounts@dashboard')->name('user-dashboard');
Route::get('amazon', 'ProductController@amazon')->name('amazon');
Route::get('electronics', 'ProductController@amazon1')->name('amazon1');
Route::post('email-check', 'Users@emailDuplicateCheck')->name('email-check');
Route::group(['middleware'=> ['auth'],'prefix'=>'user'], function()
{
    ...
    */
    ...
    Route::get('account/update', 'UserAccounts@modifyNew')->name('profile-update');
    Route::get('account/modify', 'UserAccounts@modify');
    Route::get('account/modify-password', 'UserAccounts@modifyPassword');
    Route::get('account/update-password', 'UserAccounts@modifyPasswordNew')->name('password-update');
    Route::get('account/modify-payout-preference', 'UserAccounts@modifyPayoutPreference');
    Route::get('account/delete-account', 'UserAccounts@deleteAccount')->name('delete-account');
    ...
    */
    ...
    Route::get('inbox', 'Messages@inbox')->name('inbox');
